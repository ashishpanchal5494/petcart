...
const CatPage: React.FC = () => {
  ...
  const fetchCat = async () => {
    ...
    try {
      ...
      const response = await fetch("https://api.thecatapi.com/v1/images/search?limit=99", requestOptions);
          ...
          <div className="row align-items-end mb-60">
            <div className="col-lg-6">
              <div className="section-title text-center text-lg-left">
                ...
                <h2 className="title">All Cats</h2>
              </div>
            </div>
          </div>
                ...
                <div className="movie-item movie-item-three mb-50">
                  <div className="movie-poster">
                    ...
                    <ul className="overlay-btn">
                      ...
                      <li>
                        <Link to={`/cat/${item.id}`} className="btn">
                          Details
                        </Link>
                      </li>
                    </ul>
